...
const Swap: React.FC<SwapProps> = ({ tokens, pools }) => {
  ...
  const [sellAmount, setSellAmount] = useState<string>('0') // Use string for handling decimals correctly
  ...
  const swap = async () => {
    ...
    try {
      const payload = NewSwapAction(sellToken.address, buyToken.address, sellAmount, sellToken.address, pool.poolAddress)
          ...
          <div className="space-y-6">
            ...
            <div className="border border-gray-700 rounded-xl p-4">
              ...
              <div className="flex items-center justify-between">
                <input
                  type="text" // Change to text to handle decimals as strings
                  id="sellAmount"
