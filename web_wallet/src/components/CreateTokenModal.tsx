  ...
  return (
    <>
      <button
        ...
        className="px-4 py-2 text-sm font-medium text-white bg-green-700 rounded-md shadow-sm hover:bg-green-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-700 transition-colors duration-200"
      >
        Create Token
      </button>
