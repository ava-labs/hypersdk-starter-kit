  ...
  return (
    <>
      <button
        ...
        className="px-4 py-2 text-sm font-medium text-white bg-black rounded-md shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200"
      >
        Create Token
      </button>
